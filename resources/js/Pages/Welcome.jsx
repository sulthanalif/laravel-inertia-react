            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                <div className="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                            ...
                            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 xl:px-8">
                                {posts.data &&
                                    posts.data.map((post) => (
                                        <div
                                            key={post.id}
                                            className="bg-white rounded-md border border-gray-200 p-6 my-4"
                                        >
                                            <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 my-4">
                                                ...
                                                <Link
                                                    href="#"
                                                    className="inline-flex items-center text-sm text-blue-600 dark:text-blue-500 "
                                                >
                                                    <PrimaryButton>
                                                        Read more
                                                        <svg
                        ...
                        <footer className="pb-12 pt-8 flex text-center text-sm text-black dark:text-white/70 justify-center items-center">
